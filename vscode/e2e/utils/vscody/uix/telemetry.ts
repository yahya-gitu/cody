...
export type Signatures = keyof typeof telemetryEvents
export type Actions = SplitSignature<Signatures>[1]
export type Features = SplitSignature<Signatures>[0]
...
export interface PropMatchFnOpts {
    feature?: LiteralUnion<Features, string>
    action?: LiteralUnion<Actions, string>
}
